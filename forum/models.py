...
class ForumPost(models.Model):
    ...
    movie = models.ForeignKey(
        Movie, on_delete=models.CASCADE, related_name='related_movie')
    ...
    upvotes = models.ManyToManyField(
        User, related_name='forum_post_upvotes', blank=True)
    downvotes = models.ManyToManyField(
        User, related_name='forum_post_downvotes', blank=True)
...
class PostComment(models.Model):
    ...
    post = models.ForeignKey(
        ForumPost, on_delete=models.CASCADE, related_name='original_post')  # Related post
    author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='comment_author')  # Comment author
