...
#     path('<slug:movie_slug>/<slug:forum_post_slug>/', views.forum_post_detail, name='forum_post_detail'),
...
urlpatterns = [
    ...
    path('post/<int:post_id>/upvote/', views.upvote_post, name='upvote_post'),  # Ensure this line is before forum_post_detail
    path('post/<int:post_id>/downvote/', views.downvote_post, name='downvote_post'),  # Ensure this line is before forum_post_detail
